...
@section('context')
    ...
    <div class=" col-4 offset-8 alert alert-primary alert-dismissible fade show" role="alert">
       <strong>
           <i class="zmdi zmdi-local-pizza me-2 text-danger"></i>
          {{session("contactSuccess")}}</strong>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form method="POST" action="{{route('user#contact')}}" name="sentMessage" id="contactForm" novalidate="novalidate">
                        @csrf
            ...
            <div class="col-lg-5 mb-5">
              ...
              {{-- src="{{asset('img/mandalyMap.jpg')}}" --}}
                    frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <div class="bg-light p-30 mb-3">
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, Mandalay, Aung MyayTharZan</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>kaungkhants894@example.com</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+95 09796788834</p>
                </div>
            </div>
        </div>
    </div>
