...
<form action="{{route('user#edit')}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
    @csrf

    <div class=" d-flex  justify-content-center border-solid border-1 border-black imgContainer">
        @if (Auth::user()->user_img === null)
   <img src={{asset("img/account-icon-png-2.jpg")}} style=" width: 130px; height:130px" alt="">
@else
<img src='{{asset("storage/".Auth::user()->user_img)}}'   style=" width: 130px; height:130px"  alt="John Doe" />
@endif
    </div>
